...
import { quartos, featureLabel, formatBRL } from "@/lib/hostel-data";
  ...
  return (
    <div className="p-8 max-w-6xl">
      <header className="flex items-end justify-between mb-8">
        <div>
          <h1 className="font-display text-3xl">Quartos & vagas</h1>
          <p className="text-muted-foreground text-sm mt-1">Gerencie a disponibilidade e características de cada vaga.</p>
        </div>
            ...
            <header className="flex flex-wrap items-center justify-between gap-3 p-5 border-b border-border">
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <Badge variant="secondary">{q.capacidade} vagas</Badge>
